...
public class Achgiv implements CommandExecutor
{
    public Main plugin;
    public Achgiv(Main instance)
    {
        plugin = instance;
    }
    ...
    {
        if (commandLabel.equalsIgnoreCase("achgiv") || commandLabel.equalsIgnoreCase("blubbernuggets"))
        {
            if (sender instanceof Player)
            {
                Player p = (Player) sender;
                if (p.hasPermission("nonamedorg.achgiv"))
                {
